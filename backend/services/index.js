...
const createContact = (contact) => {
  ...
  return (new Promise((resolve, reject) => {
    phoneReference.set({ name: contact.name, phone: contact.phone }, (error) => {
      if (error) {
...
const updateContact = (contact) => {
  ...
  return (new Promise((resolve, reject) => {
    phoneReference.update({ name: contact.name, phone: contact.phone }, (error) => {
      if (error) {
...
module.exports = { getContacts, getPages, createContact, updateContact, deleteContact, searchContacts, searchContactsPages}